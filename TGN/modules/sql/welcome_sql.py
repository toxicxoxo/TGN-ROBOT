...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined the chat - HOMIES!",
    "{first} just joined. Everyone, look busy!",
    "Welcome, {first}. TERI HE KAMI THI.",
    "Welcome, {first}. CHAL ENJOY KR AB ( ͡° ͜ʖ ͡°)",
    "Welcome, {first}. ACHA HAI AGYA.",
    "Welcome, {first}. MISSING ZEUS.",
